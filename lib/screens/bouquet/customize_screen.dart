        ...
        body: SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Container(
              ...
              child: BouquetPreview(flowers: prov.flowers, wrapper: prov.wrapper, height: 200),
            ),
            const SizedBox(height: 28),

            // Wrapper
            Text('Ambalaj Rengi', style: Theme.of(context).textTheme.titleLarge),
            const SizedBox(height: 12),
            Wrap(spacing: 10, runSpacing: 10,
              children: WrapperStyle.values.map((w) {
                final sel = prov.wrapper == w;
                return GestureDetector(
                  onTap: () => prov.setWrapper(w),
                  child: AnimatedContainer(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Text(w.label, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500,
